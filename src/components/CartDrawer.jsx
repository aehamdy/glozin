...
function CartDrawer({ isCartOpen, handleCloseCart }) {
  return (
    <>
      ...
      {/* Cart Drawer */}
      <div
        className={`fixed top-0 right-0 w-10/12 md:w-3/5 lg:w-2/5 h-full flex flex-col py-4 px-4 bg-primary-light rounded-l-small overflow-hidden z-top transition-all duration-[350ms] ease-in-out transform ${
