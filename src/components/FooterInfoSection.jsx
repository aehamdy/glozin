  ...
  return (
    <>
      <div className="flex flex-col items-center md:items-start gap-2 md:gap-4 lg:gap-8">
        ...
        <p className="w-3/4 md:w-full text-sm md:texe-base text-center md:text-start">
          Find a location nearest you to reduce shipping costs and make shopping
          easier.
        </p>
        <div className="flex flex-col items-center md:items-start gap-1 lg:gap-3 text-sm md:texe-base ">
