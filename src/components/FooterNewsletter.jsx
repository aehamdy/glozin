...
function FooterNewsletter() {
  return (
    ...
    <div className="grid md:col-span-2 lg:col-span-1 lg:text-start">
      ...
      <p className="w-full lg:w-10/12 text-sm md:text-base  text-start md:text-center lg:text-start">
      ...
      <p className="w-full lg:w-11/12 text-sm md:text-base text-start md:text-center lg:text-start">
