...
function FooterNewsletter() {
  return (
    ...
    <div className="grid md:col-span-2 lg:col-span-1 lg:text-start">
      ...
      <p className="w-full lg:w-10/12 text-xs md:text-base text-center lg:text-start mt-2 md:mt-0">
      ...
      <p className="w-full lg:w-11/12 text-xs md:text-base text-center lg:text-start">
