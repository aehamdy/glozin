...
function ProductCardSideButtons({ productId, removeFromWishlist }) {
  ...
  return (
    <div className="absolute flex flex-col gap-4 top-5 end-2 lg:end-0 lg:translate-x-full group-hover:lg:-translate-x-2 lg:opacity-0 lg:group-hover:opacity-100 group-hover:z-50 transition-all duration-medium">
