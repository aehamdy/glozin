...
function Nav({ navVisibility, onClickFunction }) {
  return (
    <>
      ...
      <nav
        className={`lg:hidden absolute top-0 left-0 flex-col items-start w-2/3 h-full bg-primary-light z-50 rounded-r-small overflow-hidden transition-all duration-[350ms] ease-in-out transform ${
          navVisibility
